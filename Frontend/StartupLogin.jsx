...
function ForgotPassword({ onBack }) {
  ...
  async function sendOtp(e) {
    e.preventDefault();
    setLoading(true);
    const res = await apiCall('/auth/startup/forgot-password', 'POST', { email });
  ...
  async function resetPass(e) {
    ...
    setLoading(true);
    const res = await apiCall('/auth/startup/reset-password', 'POST',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ textAlign: 'center', paddingBottom: 4 }}>
        ...
        <p style={{ fontSize: 13, opacity: 0.6 }}>
          {step === 'email'   && 'Enter your registered business email'}
        ...
        {mode === 'forgot' ? (
          ...
          <>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              ...
              <h2 style={{ fontWeight: 700, fontSize: '1.4rem', color: '#1f2937' }}>Startup Login</h2>
              <p style={{ fontSize: 13, opacity: 0.6, marginTop: 4 }}>Sign in with your business email</p>
            </div>
            ...
            <form onSubmit={handleLogin}
              ...
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, display: 'block',
                  marginBottom: 6, color: '#374151' }}>Business Email</label>
